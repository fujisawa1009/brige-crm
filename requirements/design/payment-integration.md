...
| **R-13（2026-08-19追加。出典: 2026-08-18浅賀MTG）** | **ネットムーブとの決済会社契約の巻き直しが未了**（社内SSSでの契約再締結が必要とMTGで判明）。契約が完了しない限り本番接続審査・決済開通（P5-14/R8-D-1）そのものが進められない | システム実装とは独立した社内手続き。W-4（情シス連携）と同様に**リードタイムが長い外部依存**として早期着手が必要。9月リリース希望（Q-1）に対する重大リスク。担当・期限を決定者へ確認要 |
